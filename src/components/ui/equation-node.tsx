...
const EquationPopoverContent = ({
  ...
  return (
    <PopoverContent
      className={cn("flex gap-1 p-1", { "min-w-[500px]": !isInline })}
      onEscapeKeyDown={(e) => {
        e.preventDefault();
      }}
      contentEditable={false}
    >
      <EquationInput
        className={cn(
          "max-h-[50vh] grow resize-none p-1 outline-none text-sm rounded-sm font-mono",
          className
        )}
      ...
      <Button className="px-3" size={"sm"} onClick={onClose}>
